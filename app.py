...
st.markdown("""
    <style>
        ...
        .stApp {
            background: linear-gradient(to right, #714674, #9f6976);
        }
    </style>
...
st.markdown("""
    <div style='text-align: center; font-size: 50px; font-weight: bold; color: #b2c9ad; margin-top: 20px;'>
...
# Image
st.image("electric-car.jpg", use_container_width=True)
...
st.markdown("Prepared by **Tanushree Ray** for the **AICTE Internship Cycle 2 by S4F**")
